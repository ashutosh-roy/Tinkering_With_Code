...
public class LinkedListCrud {
    ...
    public static LinkedListCrud deleteByKey(LinkedListCrud list, int data) {
        // Case 1 : If head node has the key, unlink the head node from the existing key and point to the next key !
        Node current_node = list.head;
        ...
        {
            // Case 2 : If the key is somewhere in the middle, then make the previous node point to the node next to current node
