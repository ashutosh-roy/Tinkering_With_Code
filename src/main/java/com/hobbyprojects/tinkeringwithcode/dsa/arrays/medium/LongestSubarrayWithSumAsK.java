...
public class LongestSubarrayWithSumAsK {
  ...
  public static void main(String[] args) {
    ...
    log.info(
        "Max Subarray with Two Pointers Length = %s"
            .formatted(subarraySumUsingTwoPointers(num, k)));
  }
  ...
  static void dryRun(String message, Map<Integer, Integer> prefixSum, int ans, int sum) {
    ...
    prefixSum.forEach((key, value) -> log.info("key = %s and value = %s".formatted(key, value)));
