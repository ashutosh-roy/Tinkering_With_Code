...
/**
 * Why learn example of inner class ? Java 8 has lambda functions which use ___Two types of inner
 * classes : Local Anonymous ___Lambda expressions use some version of anonymous classes. Why learn
 * lambda ? It was introduced in Java 8.
 *
