...
/**
 * ``` In Java, things are strictly Pass By Value (for objects, Pass BY VALUE occurs and it means
 * that REFERENCE is passed as VALUE.)
 *
 * <p>Pass By Reference : Scenario --- If teacher has given his original class notes doc to a
 * student, any changes he makes there will reflect in others who have the sheet.
 *
 * <p>Pass By Value : Scenario --- If teacher has given his printout of Original class notes doc to
 * a student, any changes he makes there will reflect in others who have the sheet.
 *
 * <p>Pass By Reference, happens in C with the help of pointers.
 *
 * <p>```
 */
